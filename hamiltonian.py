...
MODIFIED 24-01-2021 by Brett Henderson <brettrhenderson25@gmail.com>:
    Implemented all methods with "# TO COMPLETE" identifiers.
'''
...
class TwoBodyFermionicHamiltonian(FermionicHamiltonian):
    ...
    def change_basis(self,transform):
        ...
        # TO COMPLETE (after activity 2.2)
        # Hint : make use of np.einsum
        new_integrals = np.einsum('mi,nj,ok,pl,mnop->ijkl', *([transform]*4), self.integrals)
